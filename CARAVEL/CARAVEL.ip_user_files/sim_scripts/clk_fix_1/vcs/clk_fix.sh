...
#
# Script generated by Vivado on Fri Jan 16 12:53:27 -0500 2026
...
#
# Usage        : clk_fix.sh
#                clk_fix.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_fix.sh [-reset_run]
#                clk_fix.sh [-reset_log]
#                clk_fix.sh [-help]
#
...
#                script (type 'clk_fix.sh -help' for more information).
#
...
# script info
echo -e "clk_fix.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_fix.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.clk_fix xil_defaultlib.glbl -o clk_fix_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./clk_fix_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key clk_fix_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc clk_fix_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clk_fix.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clk_fix.sh [-help]\n\
Usage: clk_fix.sh [-step]\n\
Usage: clk_fix.sh [-lib_map_path]\n\
Usage: clk_fix.sh [-reset_run]\n\
Usage: clk_fix.sh [-reset_log]\n\
Usage: clk_fix.sh [-keep_index]\n\
Usage: clk_fix.sh [-noclean_files]\n\n\
