...
#
# Script generated by Vivado on Sun Jan 25 19:09:17 -0500 2026
...
#
# Usage        : floating_point_div.sh
#                floating_point_div.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                floating_point_div.sh [-reset_run]
#                floating_point_div.sh [-reset_log]
#                floating_point_div.sh [-help]
#
...
#                script (type 'floating_point_div.sh -help' for more information).
#
...
# script info
echo -e "floating_point_div.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./floating_point_div.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.floating_point_div xil_defaultlib.glbl -o floating_point_div_simv
}
...
reset_run()
{
  files_to_remove=(ucli.key floating_point_div_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc floating_point_div_simv.daidir vcs_lib c.obj)
...
Usage: floating_point_div.sh [-step]\n\
Usage: floating_point_div.sh [-lib_map_path]\n\
Usage: floating_point_div.sh [-reset_run]\n\
Usage: floating_point_div.sh [-reset_log]\n\
Usage: floating_point_div.sh [-keep_index]\n\
