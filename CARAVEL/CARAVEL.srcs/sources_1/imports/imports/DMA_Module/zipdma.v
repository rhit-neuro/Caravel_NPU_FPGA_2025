...
//
// Edited by: Josh Schrock 1/8/2025
//
////////////////////////////////////////////////////////////////////////////////
// }}}
...
module zipdma #(
		...
		// Slave port ***UPDATED FOR WISHBONE B3***
		// {{{
		// Slave/control wishbone inputs ***UPDATED FOR WISHBONE B3***
		input	wire			i_swb_cyc, i_swb_stb, i_swb_we,
		input	wire	[1:0]		i_swb_addr,
		input	wire	[SLV_WIDTH-1:0]	i_swb_data,
		input	wire [SLV_WIDTH/8-1:0]	i_swb_sel,
		// Slave/control wishbone outputs ***UPDATED FOR WISHBONE B3***
