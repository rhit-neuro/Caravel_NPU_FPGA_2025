...
module	sdspi #(
		...
		parameter [CKDIV_BITS-1:0]	INITIAL_CLKDIV = 8'h0,
		// }}}
		// OPT_SPI_ARBITRATION
		// {{{
...
//	initial	o_wb_ack = 0;//-----------CHANGED!!------------ 
//	always @(posedge i_clk)
//	if (!i_wb_cyc)
//		o_wb_ack <= 1'b0;
//	else
//		o_wb_ack <= dly_stb; 
    assign o_wb_ack = wb_stb;
