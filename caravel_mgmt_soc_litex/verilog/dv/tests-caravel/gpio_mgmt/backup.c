 ...
 */
 ...
 void loadMemory() {
     volatile uint32_t *base_address; // address variable
 
     // load V tables into memory
     base_address = (volatile uint32_t *) 0x30501100;
     ...
     *base_address = (uint32_t) 0x41400000; 
     ...
     base_address = (volatile uint32_t *)0x30501200;
     ...
     *base_address = (uint32_t) 0x2cb5d776; 
     ...
     base_address = (volatile uint32_t *)0x30501300;
 ...
 void dma_config(volatile uint32_t control_value, volatile uint32_t length_value, volatile uint32_t from_value, volatile uint32_t to_value) {
         volatile uint32_t *length = (uint32_t *)0x3040000c;
         volatile uint32_t *to = (uint32_t *)0x30400008;
         volatile uint32_t *from = (uint32_t *)0x30400004;
         volatile uint32_t *control = (uint32_t *)0x30400000;
 ...
 void lut_function1(volatile uint32_t input,volatile  uint32_t *memory){
     //access calculations
     volatile uint32_t *LUT_func1 = (volatile uint32_t *)0x30501000; //LUT function 1 address
     *LUT_func1 = input;		//load lut input
     volatile uint32_t func1_result = *LUT_func1;	//read result
 ...
 void main()
 {
    ...
    //  dma_config((uint32_t) 0x00000000,(uint32_t) 0x00000080,(uint32_t) 0x30000300,(uint32_t) 0x30501300); //Load B table
     ...
     while(1){
         ...
         lut_function1((volatile uint32_t) 0xbe9a2681, (volatile uint32_t *) 0x30000600);
         lut_function1((volatile uint32_t) 0x40a00000, (volatile uint32_t *) 0x30000604);
         lut_function1((volatile uint32_t) 0xc13773a1, (volatile uint32_t *) 0x30000608);
         lut_function1((volatile uint32_t) 0x40c00000, (volatile uint32_t *) 0x3000060c);
     }
