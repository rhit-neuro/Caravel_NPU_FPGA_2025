...
void loadMemory() {
	...
	base_address = (uint32_t *) 0x30000100;
    ...
    *base_address = (uint32_t) 0x41400000; 
	...
	base_address = (uint32_t *)0x30000200;
    ...
    *base_address = (uint32_t) 0x2cb5d776; 
	...
	base_address = (uint32_t *)0x30000300;
...
void lut_function1(volatile uint32_t input,volatile  uint32_t *memory){
	//access calculations
	volatile uint32_t *LUT_func1 = (uint32_t *)0x30501000; //LUT function 1 address
...
void main()
{
	...
	while(1){
		...
		lut_function1((uint32_t) 0xbe9a2681, (uint32_t *) 0x30000600);
		lut_function1((uint32_t) 0x40a00000, (uint32_t *) 0x30000604);
		lut_function1((uint32_t) 0xc13773a1, (uint32_t *) 0x30000608);
		lut_function1((uint32_t) 0x40c00000, (uint32_t *) 0x3000060c);
	}
